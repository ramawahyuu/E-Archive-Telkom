...
<style>
    ...
    .gantt-chart {
        ...
        width: 100%;
        min-width: 600px; /* Minimum width of the chart */
    }
    ...
    .gantt-chart th {
        ...
        color: #000000; /* Light grey background for headers */
    }

    .gantt-chart .planning {
        background-color: #0EE009; /* Green for planning */
    }

    .gantt-chart .execution {
        background-color: #EDFFED; /* Blue for execution */
    }

    /* Specific day columns */
    .gantt-chart th:nth-child(n+3), .gantt-chart td:nth-child(n+3) {
        width: 20px; /* Width of day columns */
        min-width: 20px;
    }
        .text-left {
        text-align: left;
      ...
      <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
          <div class="card" style="margin-top: 130px;">
            <div class="card-body">
              <h1 style="font-weight:600; font-size:30px;">Proses Pelaksanaan Perlombaan PKM</h1>
  ...
  <table class="gantt-chart">
    ...
    <tbody id="ganttBody">
      ...
      <tr>
        ...
        <th colspan="35" style="text-align: left;">Kemahasiswaan</th>
        ...
        @if($task->jenis_agenda == 'kemahasiswaan')
          ...
          <tr>
            ...
            <td rowspan="2">
              ...
              <button type="button" class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#editTaskModal{{ $task->id }}" style="border-radius: 15px; padding: 5px 10px;">

                <i class="mdi mdi-pencil"></i> Edit

              </button> 

              <form action="{{ route('tasks.destroy', $task->id) }}" method="POST" style="display: inline-block;" onsubmit="return confirmDelete(event)">

                @csrf

                @method('DELETE')

                <button type="submit" class="btn btn-danger btn-sm" style="border-radius: 15px; padding: 5px 10px;">Delete</button>
          ...
          <tr>
            ...
            @if($emptyCellsBeforeExecution > 0)
...
<tr>
        ...
        <th colspan="35" style="text-align: left;">Mahasiswa</th>
...
<div class="form-group mb-3">
    ...
    <div class="form-group mb-3">
        ...
        <input type="text" class="form-control" id="dokumentasi" value="{{ $task->dokumentasi }}" name="dokumentasi" required>
    </div>
    ...
    <select class="form-control" id="jenis_agenda" name="jenis_agenda" required>
        ...
        <option value="mahasiswa">Mahasiswa</option>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <div class="form-group mb-3">
                        <label for="dokumentasi">Dokumentasi:</label>
                        <input type="text" class="form-control" id="dokumentasi" name="dokumentasi" required>
                    </div>
                    <button type="submit" class="btn btn-primary">Simpan</button>
                </form>
            </div>
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 90%;">
                                                    <div>
                                                        ...
                                                        {{ $task->pengubah }}</b> {{ $task->alasan }}</p>
                                                    </div>
                                                </td>
                                                <td>
                                                   <p><strong>Dokumentasi: </strong></p>
                                                        <a class="nav-link" target="_blank" href="{{ str_replace(url('/'), '', $task->dokumentasi) }}">
