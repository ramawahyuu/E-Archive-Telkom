                ...
                <form method="POST" action="{{ route('prestasi.store') }}">
                    @csrf
                         ...
                         <div class="row mb-3" style="margin:10px">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="nama" placeholder="Nama " style="border: 1px solid #7A7878;" name="nama" required>
                            </div>
                        </div>
                         <div class="row mb-3" style="margin:10px">
                        ...
                        <div class="row mb-3" style="margin:10px">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="nomor" placeholder="No. HP" style="border: 1px solid #7A7878;" name="nomor" required>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3" style="margin:10px">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="prestasi" placeholder="Prestasi" style="border: 1px solid #7A7878;" name="prestasi" required>
                            </div>
                        </div>
